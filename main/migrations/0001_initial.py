    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "qualification",
                    models.CharField(blank=True, max_length=500, null=True, verbose_name="Квалификация"),
                ),
                ...
                ("avatar", models.ImageField(blank=True, null=True, upload_to="doctor/")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("photo", models.ImageField(blank=True, null=True, upload_to="patient/")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("appoint_date", models.DateTimeField(blank=True, null=True, verbose_name="Дата приема врача")),
                (
                    "owner",
                    models.ForeignKey(
                        default=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(blank=True, max_length=100, null=True, verbose_name="Единицы измерения"),
                ),
                (
                    "reference_value",
                    models.CharField(blank=True, max_length=100, null=True, verbose_name="Референсное значение"),
                ),
                (
                    "patient",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="main.patient", verbose_name="Пациент"
                    ),
                ),
            ],
            options={
